<template>
  <footer class="border-star-gray/10 bg-space-black border-t py-8">
    <div
    ...
    >
      <span class="inline-flex items-center gap-1">
        <Icon name="mdi:copyright" class="h-4 w-4" aria-hidden="true" /> 2026 Hugo Bollon. All
        rights reserved.
      </span>
      <a
        ...
        target="_blank"
        aria-label="Hugo Bollon on GitHub"
      >
        <Icon name="mdi:github" class="h-4 w-4" aria-hidden="true" />
        Source
      </a>
    </div>
  </footer>
